...
document.getElementById("header_wrapper_mobile_toggle").onclick = function () {
  ...
  var spokenOnlyText = document.getElementById("spokenonlytext");
  if (spokenOnlyText.innerHTML === "Open main menu") {
    spokenOnlyText.innerHTML = "Close main menu";
  } else {
    spokenOnlyText.innerHTML = "Open main menu";
  }
};
